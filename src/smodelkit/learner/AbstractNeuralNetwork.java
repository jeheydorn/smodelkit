...
//
///**
// * An abstract base class for multi-layer perceptrons.
// * @author joseph
// *
// */
//@SuppressWarnings("serial")
//public abstract class AbstractNeuralNetwork extends SupervisedLearner
//{
...
//		if (layers != null)
//		{
//			Logger.println("Network input count: " + tInputs.cols());
...
//	}
//	
//	protected abstract void saveLayers();
//	
//	protected abstract void restoreLayers();
//
//	/**
...
//			if (runOnGPU)
//			{
//				int numWeights = layers[i][0].getWeights().length;
//				double[] layerWeights = new double[layers[i].length * numWeights];
//				for (int j = 0; j < layers[i].length; j++)
//				{
//					for (int wI = 0; wI < numWeights; wI++)
//					{
//						layerWeights[j*numWeights + wI] = layers[i][j].getWeights()[wI];
//					}
//				}
//				
//				Kernel kernel = layers[i][0].createHiddenLayerOutputKernel(inputs.getValues(), layerWeights, 
//				 		layers[i][0].getWeights().length, outputs[i]);
//
